<!-- <h1 align="center">
🚧 ignite-Chapter2-desafio-one | Em Construção 🚧
</h1> -->

<h1 align="center">
  Bem Vindo ao ignite-Chapter2-desafio-one
</h1>
...
- `server`: Executa o servidor fake
